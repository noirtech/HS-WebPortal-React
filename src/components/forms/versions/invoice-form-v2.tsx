  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-hidden">
                        ...
                        {lineItems.map((item, index) => (
                          <div 
                            ...
                            className={`px-4 py-3 transition-colors ${
                              activeRow === item.id ? 'bg-blue-50 border-l-4 border-l-blue-500' : 'hover:bg-gray-50'
                            }`}
                            ...
                            <div className="grid grid-cols-12 gap-3 items-center">
                              <div className="col-span-5">
                                <Input
                                  ...
                                  className="text-sm h-8 border-0 bg-transparent focus:bg-white focus:border focus:border-blue-300"
                                />
                              </div>
                              <div className="col-span-2">
                                <Input
                                  ...
                                  className="text-sm font-mono h-8 border-0 bg-transparent focus:bg-white focus:border focus:border-blue-300"
                                />
                              </div>
                              <div className="col-span-2">
                                <Input
        ...
        {/* Enhanced Footer */}
        <div className="flex-shrink-0 border-t bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4">
